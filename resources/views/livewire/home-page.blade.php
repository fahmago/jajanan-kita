<div>
    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Kalo Jajan di <span class="text-blue-600">JajanKita</span> aja!</h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Gabut? iseng? semua jajanan disini bakal ngilangin itu semua, ayo diborong!</p>
        ...
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"> Pilih Warung Favorit<span class="text-blue-500"> Kamu!
                </span> </h1>
            ...
            <p class="mb-12 text-base text-center text-gray-500">
              Semua produk dibuat hanmade dari mahasiswa dengan menggunakan bahan baku yang berkualitas dan halal.
            </p>
          </div>
        </div>
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"> Jajan Apa <span class="text-blue-500"> Hari Ini?
                </span> </h1>
              <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                <div class="flex-1 h-2 bg-blue-200">
                </div>
            ...
            <p class="mb-12 text-base text-center text-gray-500">
              Mau jajan apa hari ini? Kami menyediakan berbagai macam jenis makanan dan minuman yang bisa kamu cari.
            </p>
          </div>
        </div>
