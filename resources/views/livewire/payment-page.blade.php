			...
			<div class="md:col-span-12 lg:col-span-8 col-span-12">
				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						<li>
							<input wire:model='payment_method' class="hidden peer" id="payment-midtrans" type="radio"
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
             ...
             @this.on('snap-token-generated', (event) => {
                 const token = event.token; // Access the token from event details
                  snap.pay(token, {
        ...
        // Alternative method if we just rely on render cycle and property update
        // We can hook into the Livewire commit hooks or just check property change.
        // But event is cleaner. I will need to emit the event from PHP.
    </script>
</div>